...
<body>
    ...
    <form action="{{ route('siswa.store') }}" method="POST" onsubmit="return validasiForm()">
        ...
        <input type="text" name="NRP" id="NRP" maxlength="10" value="{{ old('NRP') }}" required><br><br>

        <label>Nama (Max 20 karakter):</label><br>
        <input type="text" name="Nama" id="Nama" maxlength="20" value="{{ old('Nama') }}" required><br><br>

        <label>Kelas (Max 5 karakter):</label><br>
        <input type="text" name="Kelas" id="Kelas" maxlength="5" value="{{ old('Kelas') }}" required><br><br>

        <label>Tanggal Lahir:</label><br>
        <input type="date" name="TanggalLahir" id="TanggalLahir" value="{{ old('TanggalLahir') }}" required><br><br>
